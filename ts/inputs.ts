export interface ControllerLayout {
    ...
    right: string | number
    down: string | number
    fireRed: string | number
    fireBlue: string | number
}
...
const PLAYER_1_LAYOUT: ControllerLayout = {
    up: "ArrowUp",
    left: "ArrowLeft",
    right: "ArrowRight",
    down: "ArrowDown",
...
const PLAYER_2_LAYOUT: ControllerLayout = {
    up: 12,
    left: 14,
    right: 15,
    down: 13,
...
export const keyUpHandler = (e: KeyboardEvent) => {
    if (e.code == PLAYER_1_LAYOUT.up) {
...
export const getInputStates = (): InputState[] => {
